...
<div id="sidebar" role="complementary">
	...
	<?php if ( is_user_logged_in() ) : ?>
		...
		<div id="sidebar-me">
			...
			<a class="btn btn-outline-danger btn-sm logout" href="<?php echo wp_logout_url( wp_guess_url() ); ?>"><?php _e( 'Log Out', 'buddypress' ); ?></a>
	...
	<?php else : ?>
		...
		<form name="login-form" id="sidebar-login-form" class="standard-form" action="<?php echo site_url( 'wp-login.php', 'login_post' ); ?>" method="post">
			...
			<input class="btn btn-primary" type="submit" name="wp-submit" id="sidebar-wp-submit" value="<?php esc_attr_e( 'Log In', 'buddypress' ); ?>" tabindex="100" />
